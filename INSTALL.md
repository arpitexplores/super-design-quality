...
5. Rename the extracted folder from `super-design-quality-main` to `super-design-quality`.
6. Copy the renamed `super-design-quality` folder into your agent's skills directory.
...
This repository is the `super-design-quality` skill. Keep the full `super-design-quality` folder together when installing it.
